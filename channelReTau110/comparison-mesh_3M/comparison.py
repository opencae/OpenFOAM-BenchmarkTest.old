...
basenameArray=[
    ...
    ,['FOCUS_A-mesh_3M-No4','FOCUS A', "0.0", '-', r'$\bowtie$', -1, "close"]
    ,['FOCUS_D-mesh_3M-No4','FOCUS D', "0.2", '-', 'D', -1, "close"]
    ,['FOCUS_F-mesh_3M-No1','FOCUS F', "0.4", '-', '>', -1, "close"]
    ,['FOCUS_H-mesh_3M-No1','FOCUS H', "0.6", '-', 'H', 24, "close"]
    ,['AWS_c4.8xlarge-mesh_3M-No3','EC2 c4.8xlarge', 'm', '-', 'x', -1, "close"]
    ,['Azure_A9-mesh_3M-No04','Azure A9', 'b', '-', '+', -1, "close"]
    ]

nodeLarge=[1,2,3,4,5,6,7,8,10,12,16,20,24]
...
def plotCPUChargePerHourVsNumberOfTimesStepPerHour(args,base,basenameArray,report,year):
    ...
    for basename in basenameArray:
        if basename[6] != "both" and basename[6] != report:
            continue
