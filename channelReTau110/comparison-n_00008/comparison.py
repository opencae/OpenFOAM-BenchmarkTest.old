...
base="all"
basenameArray=[
    ['Oakleaf_FX-2.3.0-n_00008-No1','Oakleaf-FX', 'r', '-', 'o']
    ,['TSUBAME_S-OF230-gcc_4.8.4-openmpi_1.6.5-ncpus_10-n_00008-No1','TSUBAME S', 'k', '-', 'v']
    ,['TSUBAME_G-RCdev-cuda_6.5-openmpi_1.8.4-gpus_3-n_00008-No1','TSUBAME G(GPU)', 'g', '-', '^']
    ,['FOCUS_D-OF230-Gnu-OpenMPI-n_00008-No4','FOCUS D', 'c', '-', 'D']
    ,['AWS_c4.8xlarge-No3','EC2 c4.8xlarge', 'm', '-', 'x']
    ,['Azure_A9-No04','Azure A9', 'b', '-', '+']
    ]

nodeSmall=[1,2,3,4,5,6,7,8]
nodeLarge=[1,2,4,6,8,12,16,20,24]

plotNumberOfTimeStepPerHour(base,basenameArray,0,9,0,6000,nodeSmall)
plotNumberOfTimeStepPerHour(base,basenameArray,0,27,0,18000,nodeLarge)

plotParallelEfficiency(base,basenameArray,0,27,0,250,nodeLarge)

plotCPUChargePerTimeStep(base,basenameArray,0,27,0,1.4,nodeLarge,"close",'FYH27')
plotCPUChargePerTimeStep(base,basenameArray,0,27,0,0.3,nodeLarge,"open",'FYH27')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,8000,0,20000,"close",'FYH27')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,2400,0,6000,"close",'FYH27')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,1600,0,4000,"close",'FYH27')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,200,0,2000,"open",'FYH27')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,1200,0,10000,"open",'FYH27')

plotCPUChargePerTimeStep(base,basenameArray,0,27,0,1.4,nodeLarge,"close",'FYH28')
plotCPUChargePerTimeStep(base,basenameArray,0,27,0,0.3,nodeLarge,"open",'FYH28')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,8000,0,20000,"close",'FYH28')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,2400,0,6000,"close",'FYH28')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,1600,0,4000,"close",'FYH28')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,200,0,2000,"open",'FYH28')
plotCPUChargePerHourVsNumberOfTimesStepPerHour(base,basenameArray,0,1200,0,10000,"open",'FYH28')
